...
<main className="flex min-h-screen flex-col items-center justify-between relative top-0 left-0 w-full">
  {/* banner section */}
  <section className="main-banner w-full h-96 md:h-[50vh] lg:h-screen  flex flex-col justify-end relative py-10 ">
    <div className=" absolute md:top-[auto] bottom-4 px-auto banner-text-div w-full text-none lg:text-white my-auto">
      ...
      <h3 className=" text-center text-2xl font-semibold">Join us today!</h3>
    </div>
  </section>
