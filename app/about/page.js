  ...
  <main className="relative mt-[6rem]">
    <section className="container mx-auto my-20">
      ...
      <div className="flex flex-col md:flex-row gap-10 w-[100%] md:w-[70%] mx-auto">
        <div className="w-[90%] md:w-[50%] flex flex-col justify-center mx-auto">
          <Image src="/assets/images/rory.png" width={100} height={100} alt="team-member"
            className="w-[200px] h-[200px]  mx-auto rounded-[50%] -mb-20 z-10 team-member-img" unoptimized></Image>
        ...
        <div className="w-[90%] md:w-[50%] flex flex-col justify-center mx-auto">
          <Image src="/assets/images/David-team2.jpg" width={100} height={100} alt="team-member"
            className="w-[200px] h-[200px]  mx-auto rounded-[50%] -mb-20 z-10 team-member-img"></Image>
      ...
      <div className="mx-auto container">
        ...
        <div className="flex md:flex-row flex-col justify-center gap-10 my-10">
          <div className=" w-[100%] md:w-[50%] mx-auto">
            <Image className="w-[100%] md:w-[50%] team-member-img  mx-auto" src="/assets/images/about-serve-img.jpg"
              width={100} height={100} unoptimized></Image>
          </div>
    ...
    <section className="container mx-auto flex md:flex-row flex-col p-3 gap-3">
      ...
      <div className="md:mx-auto">
        <Image src="/assets/images/about-theycan-image.jpg" width={100} height={100} alt="content image"
          className="w-full  md:w-[300px] overflow-x-hidden mx-auto" unoptimized></Image>
      </div>
    </section>
  </main>
</>
